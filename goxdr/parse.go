...
var yyAct = [...]int{
	...
	27, 32, 112, 125, 23, 62, 115, 68, 127, 40,
	67, 83, 76, 1, 75, 107, 78, 78, 77, 18,
	20, 21, 22, 108, 42, 41, 146, 139, 41, 148,
	111, 29, 30, 28, 51, 53, 54, 34, 35, 33,
	36, 37, 38, 39, 137, 131, 63, 128, 129, 25,
	26, 73, 153, 71, 149, 49, 52, 61, 88, 147,
	145, 120, 79, 99, 128, 129, 98, 81, 80, 132,
	97, 47, 93, 86, 92, 91, 72, 69, 65, 63,
	63, 150, 130, 94, 96, 109, 57, 89, 44, 84,
	45, 63, 102, 103, 101, 105, 100, 119, 110, 104,
	60, 56, 106, 11, 13, 14, 12, 15, 16, 10,
	48, 117, 46, 43, 50, 117, 128, 129, 113, 55,
	84, 122, 58, 59, 123, 85, 19, 41, 133, 41,
	63, 136, 144, 140, 138, 135, 34, 35, 33, 36,
	37, 38, 39, 142, 41, 64, 17, 87, 74, 116,
	151, 41, 31, 152, 29, 30, 28, 95, 126, 124,
	34, 35, 33, 36, 37, 38, 39, 143, 141, 114,
	82, 134, 25, 26, 41, 90, 24, 29, 30, 28,
	70, 66, 9, 34, 35, 33, 36, 37, 38, 39,
	41, 7, 6, 8, 3, 25, 26, 4, 5, 34,
	35, 33, 36, 37, 38, 39, 118, 41, 2, 0,
	0, 0, 0, 0, 121, 41, 34, 35, 33, 36,
	37, 38, 39, 118, 34, 35, 33, 36, 37, 38,
	39, 11, 13, 14, 12, 15, 16, 10,
}
var yyPact = [...]int{

	-1000, 225, -1000, -1000, -1000, -1000, -1000, -1000, -1000, -1000,
	142, 122, 122, 122, 122, 170, 122, 86, 59, -1000,
	85, 83, 92, -1000, 21, 125, 125, -1000, 85, 83,
	92, -1000, -1000, -1000, -1000, 107, -1000, -1000, -1000, -1000,
	-1000, -1000, 73, -1000, 140, 48, 122, 47, 170, 46,
	19, -20, 125, -20, -19, -1000, -1000, -1000, -1000, -1000,
	99, 97, 43, -1000, -1000, -1000, 27, -1000, 58, -1000,
	147, -1000, -1000, 211, 42, -1000, -1000, 140, 140, 40,
	36, 33, 68, -1000, 122, -1000, -1000, 65, 122, 140,
	-1000, -1000, 125, -1000, -24, -14, -1000, -1000, -1000, -1000,
	56, -1000, 71, -1000, -1000, -1000, -3, -1000, -1000, 113,
	203, 70, 31, -1000, 186, -1000, 122, -1000, -1000, 93,
	-1000, 53, -1000, 13, 41, -1000, 24, -1000, 140, -7,
	113, 123, -1000, -1000, -1000, -1000, -1000, 30, -8, -1000,
	29, -4, -1000, 23, -1000, -1000, -1000, -1000, 52, 211,
	113, -1000, 22, -1000,
}
var yyPgo = [...]int{

	0, 208, 198, 197, 194, 193, 192, 191, 182, 90,
	181, 10, 71, 180, 4, 176, 171, 170, 11, 169,
	6, 168, 167, 159, 55, 158, 3, 9, 7, 1,
	5, 157, 0, 152, 8, 149, 2, 12, 14, 148,
	13, 147,
}
var yyR1 = [...]int{

	0, 40, 40, 1, 1, 1, 1, 1, 1, 1,
	4, 3, 2, 9, 10, 10, 11, 11, 41, 41,
...
var yyChk = [...]int{
	...
	-1000, -40, -1, -4, -3, -2, -6, -7, -5, -8,
	12, 6, 9, 7, 8, 10, 11, 4, -28, 4,
	-28, -28, -28, -14, -15, 25, 26, -32, 9, 7,
	8, -33, -29, 15, 13, 14, 16, 17, 18, 19,
	-27, 4, -28, 27, 29, -9, 27, -12, 27, -24,
	22, -27, 35, -27, -27, -9, -12, -24, 15, 16,
	27, -40, -30, -29, 5, 30, -10, -11, -28, 30,
	-13, -14, 30, 32, -39, -38, -37, 38, 36, -27,
	-38, -37, -17, -18, 21, 28, 30, -41, 31, 29,
	28, -14, -32, 30, -30, -31, -30, 30, 30, 30,
	28, -18, -28, 28, -11, -30, -27, 39, 37, 29,
	27, 33, -36, 5, -19, -20, -35, -32, 20, 27,
	30, 28, -20, -28, -23, -26, -25, -34, 23, 24,
	29, 32, 28, -26, -16, -34, -14, 20, -30, 34,
	-36, -21, 20, -22, -32, 30, 34, 30, 33, 31,
	29, -32, -36, 30,
}
var yyDef = [...]int{
	...
	79, 80, 0, 1, 0, 0, 0, 0, 0, 0,
	0, 44, 0, 0, 0, 46, 47, 48, 66, 69,
...
var yyTok1 = [...]int{
	...
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
	32, 33, 35, 3, 31, 3, 3, 3, 3, 3,
	3, 3, 3, 3, 3, 3, 3, 3, 34, 30,
	36, 29, 37, 3, 3, 3, 3, 3, 3, 3,
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
	3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
...
//line parse.y:101
		{
			yyVAL.def = &rpc_const{yyDollar[2].idval, yyDollar[4].idval}
		}
	case 12:
		yyDollar = yyS[yypt-4 : yypt+1]
//line parse.y:106
		{
			yyVAL.def = &rpc_enum{yyDollar[2].idval, yyDollar[3].constlist}
		}
	case 13:
		yyDollar = yyS[yypt-4 : yypt+1]
//line parse.y:111
...
//line parse.y:125
		{
			tag := rpc_const{yyDollar[1].idval, yyDollar[3].idval}
...
//line parse.y:131
		{
			...
			yyVAL.cnst = rpc_const{yyDollar[1].idval, lid("iota")}
		}
	case 19:
		yyDollar = yyS[yypt-1 : yypt+1]
//line parse.y:138
...
//line parse.y:144
		{
			yyVAL.def = &rpc_struct{yyDollar[2].idval, yyDollar[3].decllist}
		}
	case 21:
		yyDollar = yyS[yypt-3 : yypt+1]
//line parse.y:149
...
//line parse.y:290
		{
			yyVAL.decl = rpc_decl{typ: yyDollar[1].idval}
		}
	case 46:
		yyDollar = yyS[yypt-2 : yypt+1]
//line parse.y:294
...
//line parse.y:383
		{
			yyVAL.idval = gid(yyDollar[1].str)
		}
	case 77:
		yyDollar = yyS[yypt-1 : yypt+1]
//line parse.y:386
		{
			val, err := strconv.ParseUint(yyDollar[1].str, 0, 32)
			if err != nil {
				yylex.Error(err.Error() + " at " + yyDollar[1].str)
			}
...
//line parse.y:395
		{
			yylex.(*Lexer).Checkdup(yyDollar[1].str)
			yyVAL.idval = gid(yyDollar[1].str)
		}
	case 80:
		yyDollar = yyS[yypt-1 : yypt+1]
